...
namespace StudentManagement.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            //    new NavigationItem("Chương trình đào tạo - hệ đào tạo", false, null, _adminFacultyTrainingFormViewModel, _adminFacultyTrainingFormRightSideBar, _layoutViewModel, "School"),
            ...
            //    new NavigationItem("Bảng điểm học viên", false, null, _scoreboardViewModel, _scoreboardRightSideBar, _layoutViewModel, "DiceD10Outline"),
            ...
            //    new NavigationItem("Danh sách học viên", false, null, _adminStudentListViewModel, _studentListRightSideBar, _layoutViewModel, "SchoolOutline"),
            //    new NavigationItem("Danh sách học viên", false, null, _campusStudentListViewModel, _campusStudentListRightSideBar, _layoutViewModel, "SchoolOutline"),
        ...
        public void InitAdminNavigationItems()
        {
            ObservableCollection<NavigationItem> temp = new ObservableCollection<NavigationItem>() {
                ...
                new NavigationItem("Khóa", false, null, _adminFacultyTrainingFormViewModel, _adminFacultyTrainingFormRightSideBar, LayoutViewModel, "Domain"),
        ...
        public void InitStudentNavigationItems()
        {
            ObservableCollection<NavigationItem> temp = new ObservableCollection<NavigationItem>() {
                new NavigationItem("Lớp môn học", false, null, _adminSubjectClassViewModel, _adminSubjectClassRightSideBar, LayoutViewModel, "GoogleClassroom"),
                new NavigationItem("Chương trình đào tạo - hệ đào tạo", false, null, _adminFacultyTrainingFormViewModel, _adminFacultyTrainingFormRightSideBar, LayoutViewModel, "Domain"),
                new NavigationItem("Môn học", false, null, _adminSubjectViewModel, _adminSubjectRightSideBar, LayoutViewModel, "BookEducationOutline"),
            };
